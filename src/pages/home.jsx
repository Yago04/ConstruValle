...
export default function Home() {
  ...
  return (
    <div className="bg-brand-light dark:bg-[#0a0a0a] text-gray-950 dark:text-gray-50 min-h-screen font-sans transition-colors duration-500 overflow-x-hidden">
        ...
        <div className="max-w-7xl mx-auto px-6 w-full z-10 relative">
          <div className="max-w-2xl md:max-w-3xl space-y-6 text-left">
            ...
            <p className="max-w-xl text-gray-300 dark:text-gray-400 text-sm md:text-base leading-relaxed font-normal antialiased">
              Excelência em construções e incorporações, com quality, segurança e compromisso em cada detalhe.
            </p>
      ...
      {/* 3. STATS BAR (Correção do texto focado/apagado) */}
          ...
          {[
            ...
            <div key={index} className="flex flex-col sm:flex-row items-center sm:items-start md:items-center gap-4 justify-center sm:justify-start group">
              ...
              <div className="text-center sm:text-left">
                ...
                {/* Correção de contraste e opacidade na label */}
                <p className="text-[11px] sm:text-xs font-bold text-gray-600 dark:text-gray-300 uppercase tracking-widest mt-0.5 transition-colors">
                  {item.label}
                </p>
              </div>
            </div>
        ...
        <div className="max-w-7xl mx-auto px-6 relative z-10 grid grid-cols-1 md:grid-cols-2 gap-16 items-center">
          <div className="text-left flex flex-col items-start space-y-4">
            ...
            <p className="text-gray-400 text-base leading-relaxed max-w-lg pt-2">
              Atuamos com foco estrito em quality, cumprimento rigoroso de prazos e satisfação total dos nossos clientes, entregando projetos modernos, seguros e sustentáveis.
            </p>
            <div className="pt-4">
              <Link
                to="/sobre"
      ...
      {/* 5. OBRAS EM DESTAQUE (Correção do Carrossel Mobile e largura dos Cards) */}
      <section className="bg-white dark:bg-[#0a0a0a] py-24 text-gray-900 dark:text-white transition-colors duration-500 overflow-hidden relative">
        ...
        <div className="max-w-7xl mx-auto px-6 relative z-10">
          ...
          {/* CARROSSEL ADAPTADO: px-6 e -mx-6 expandem o scroll até as bordas físicas da tela no mobile */}
          <div className="flex gap-6 overflow-x-auto pb-8 pt-4 px-6 -mx-6 snap-x snap-mandatory scrollbar-none">
            {[
              ...
              { title: "Edifício Comercial", desc: "Construção de Prédio", tag: "Edificações", image: rio },
              { title: "Residência Alphaville", desc: "Construção de Casa", tag: "Residencial", image: pedagio }
            ].map((obra, index) => (
              <div
                key={index}
                className="w-[85vw] sm:w-[400px] shrink-0 snap-start group relative bg-neutral-50 dark:bg-[#0f0f0f] border border-gray-200/60 dark:border-neutral-900/80 rounded-2xl overflow-hidden shadow-sm hover:shadow-[0_30px_60px_rgba(0,0,0,0.12)] dark:hover:shadow-[0_30px_60px_rgba(0,0,0,0.6)] transition-all duration-500 transform hover:-translate-y-2 flex flex-col text-left"
              >
                {/* CONTAINER DA IMAGEM */}
                ...
                {/* CONTEÚDO DO CARD - Sem elementos inúteis de verificação */}
        ...
        <div className="mt-12 text-center">
          <Link
            to="/obras"
            onClick={() => window.scrollTo(0, 0)} // Força o navegador a subir no momento exato do clique
